...
// import pbk from json
F(": impbk jd: pbk ix: imkey: . ;")

// keep javascript functions (with parameters) separate from fgl functions
function fgl_rk() // restore_keys
{
    restore_keys( S.pop() );
}
...
function fgl_jd() // JSON.parse(), PHP json_decode()
{
...
function fgl_expvk()
{
    S.push( key.exportKey('pkcs8-private-pem') );
}
